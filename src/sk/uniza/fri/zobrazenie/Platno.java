...
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Sach", 800, 800,
                                         Color.lightGray);
        }
    ...
    public void setForegroundColor(String farba) {
        ...
        } else if (farba.equals("obilie")) {
            this.graphic.setColor(FarbyRGB.getFarba("obilie"));
        } else if (farba.equals("piesok")) {
            this.graphic.setColor(FarbyRGB.getFarba("piesok"));
        } else if (farba.equals("dymovoBiela")){
            this.graphic.setColor(FarbyRGB.getFarba("dymovoBiela"));
        } else {
            this.graphic.setColor(Color.black);
        }
    ...
    private class CanvasPane extends JPanel {
        public void paint(Graphics graphic) {
            ...
            for (int i = 1; i < 9; i++) {
                graphic.drawString(String.valueOf(i), 15,   90 * i);
                graphic.drawString(String.valueOf(abeceda.charAt(i - 1)), 90 * i - 10,   780);
            }
        }
    }
